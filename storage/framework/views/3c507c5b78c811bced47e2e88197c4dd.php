...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('admin.user_management.partials.user-profile-css', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            $(document).on('submit', '#notificationPreferencesForm', function (e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.notification.preferences.save')); ?>",
                    type: "POST",
                    data: formData,
                    success: function (response) {
                        if (response.success) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.notification.preferences.get')); ?>",
                type: "GET",
                success: function (response) {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\QBit Dev-2\Downloads\projects\e-commerce-laravel\resources\views/admin/user_management/user_profile.blade.php ENDPATH**/ ?>