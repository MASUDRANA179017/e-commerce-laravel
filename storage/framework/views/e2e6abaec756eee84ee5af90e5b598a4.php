...
<head>
    ...
    <title><?php echo e($business_setup->login_title ?? ($business_setup->system_name ?? 'QBit BMS')); ?> - Login</title>
    ...
    <link rel="icon" type="image/png" href="<?php echo e($business_setup->favicon ? asset('storage/' . $business_setup->favicon) : asset('frontend/assets/images/logo.png')); ?>">
    ...
    <style>
        ...
        body {
            ...
            position: relative;
            overflow: hidden;
            background: url("<?php echo e($business_setup->login_background ? asset('storage/' . $business_setup->login_background) : asset('frontend/assets/images/page-bg.jpg')); ?>") no-repeat center center;
    ...
    <div class="main-container">
        ...
        <div class="branding-section">
            <div class="mx-auto text-center">
                <img src="<?php echo e($business_setup->logo ? asset('storage/' . $business_setup->logo) : asset('frontend/assets/images/logo.png')); ?>" class="img-fluid" width="200px" alt="<?php echo e($business_setup->company_name ?? 'Logo'); ?>">
            </div>
            <h4 class="text-white text-center"><?php echo e($business_setup->login_title ?? ($business_setup->system_name ?? 'QBit BMS - Ecosystem')); ?></h4>
            <div class="authen-overlay-img mx-auto text-center mb-3">
                <img src="<?php echo e($business_setup->login_image ? asset('storage/' . $business_setup->login_image) : 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400&h=300&fit=crop'); ?>" style="width: 80%; border-radius: 15px;" alt="<?php echo e($business_setup->company_name ?? 'Illustration'); ?>">
            </div>
            <div class="text-center mx-auto mt-4">
                <p class="text-white fs-15 mb-1"><?php echo e($business_setup->login_tagline ?? 'An Integrated Ecosystem of 10 Powerful Applications'); ?></p>
                <p class="mb-0 text-white fs-13"><?php echo e($business_setup->login_copyright ?? ('Copyright © ' . date('Y') . ' - ' . ($business_setup->company_name ?? 'QBit Tech'))); ?></p>
            </div>
        </div>
        
        <div class="login-section">
            <div class="mx-auto text-center mb-4">
                <img src="<?php echo e($business_setup->logo ? asset('storage/' . $business_setup->logo) : asset('frontend/assets/images/logo.png')); ?>" class="img-fluid" width="150px" alt="<?php echo e($business_setup->company_name ?? 'Logo'); ?>">
            </div>
            <div class="text-center">
                <h2 class="fs-30 mb-2 qb-card-header-title-md">Sign In</h2>
                <p class="mb-4"><?php echo e($business_setup->login_subtitle ?? 'Unlock Ultimate Efficiency with the Complete Suite.'); ?></p>
            </div>
            ...
            <form action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" name="username" id="username" value="<?php echo e(old('username')); ?>" class="form-control custom-input <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter your username" required autofocus>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" name="password" id="password" class="form-control custom-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="remember" id="rememberMe" <?php echo e(old('remember') ? 'checked' : ''); ?> style="background-color: rgba(255,255,255,0.2); border-color: rgba(255,255,255,0.3);">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4 pb-4" style="min-height: 480px;">
                    <div class="text-center mb-4">
                        ...
                        <img src="<?php echo e($business_setup->logo ? asset('storage/' . $business_setup->logo) : asset('frontend/assets/images/logo.png')); ?>" class="img-fluid" width="100px" alt="<?php echo e($business_setup->company_name ?? 'Logo'); ?>">
                    </div>
                    <div class="text-center mb-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4 pb-4" style="min-height: 480px;">
                    <div class="text-center mb-4">
                        ...
                        <img src="<?php echo e($business_setup->logo ? asset('storage/' . $business_setup->logo) : asset('frontend/assets/images/logo.png')); ?>" class="img-fluid" width="80px" alt="<?php echo e($business_setup->company_name ?? 'Logo'); ?>">
                    </div>
                    <div class="text-center mb-4">
...
<?php /**PATH C:\Users\QBit Dev-2\Downloads\projects\e-commerce-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>