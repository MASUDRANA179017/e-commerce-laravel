                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    <div class="form-group"><label>Company Name</label><input type="text"
                                            ...
                                            value="<?php echo e($business_setup->company_name); ?>" disabled></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group"><label>Company Type</label>
                                        <select class="form-select" id="companyType" name="company_type" disabled>
                                            <option
                                                <?php echo e($business_setup->company_type == 'Private Limited Company' ? 'selected' : ''); ?>>
                                                Private Limited Company</option>
                                            <option
                                                <?php echo e($business_setup->company_type == 'Public Limited Company' ? 'selected' : ''); ?>>
                                                Public Limited Company</option>
                                            <option <?php echo e($business_setup->company_type == 'Partnership' ? 'selected' : ''); ?>>
                                                Partnership</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group"><label>Industry</label><input type="text" name="industry"
                                            class="form-control" value="<?php echo e($business_setup->industry); ?>" disabled></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group"><label>Establishment Date</label><input type="date"
                                            name="establishment_date" class="form-control"
                                            value="<?php echo e($business_setup->establishment_date); ?>" disabled></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-lg-12">
                                    <div class="form-group"><label>Street Address</label>
                                        <textarea class="form-control" name="street_address" rows="2" disabled><?php echo e($business_setup->street_address); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group"><label>City / Thana</label><input type="text"
                                            class="form-control" name="city_thana"
                                            value="<?php echo e($business_setup->city_thana); ?>" disabled></div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group"><label>District</label><input type="text"
                                            class="form-control" name="district" value="<?php echo e($business_setup->district); ?>"
                                            disabled></div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group"><label>Zip Code</label><input type="text"
                                            class="form-control" name="zip_code" value="<?php echo e($business_setup->zip_code); ?>"
                                            disabled></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group"><label>Official Contact Number(s)</label>
                                <div class="repeater" id="rp-official">
                                    <?php $vals = $business_setup->official_contact_number; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($vals)): ?>
                                        <?php $vals=['']; ?>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $vals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="input-group mb-2">
                                            <input type="text" name="official_contact_number[]" class="form-control"
                                                value="<?php echo e($v); ?>" disabled>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group"><label>Landline Number</label>
                                <input type="text" name="landline_number" class="form-control"
                                    value="<?php echo e($business_setup->landline_number); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group"><label>Website Address</label>
                                <input type="url" name="website_address" class="form-control"
                                    value="<?php echo e($business_setup->website_address); ?>" disabled>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group"><label>Facebook</label>
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                    ...
                                    <div class="w-78"><input type="text" name="facebook_url" class="form-control"
                                            value="<?php echo e($business_setup->facebook_url); ?>" disabled></div>
                                    <div class="w-15"><label class="toggle-switch"><input type="checkbox"
                                                name="facebook_status"
                                                <?php echo e($business_setup->facebook_status == '1' ? 'checked' : ''); ?>
                            ...
                            <div class="form-group"><label>LinkedIn</label>
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                    ...
                                    <div class="w-78"><input type="text" name="linkedin_url" class="form-control"
                                            value="<?php echo e($business_setup->linkedin_url); ?>" disabled></div>
                                    <div class="w-15"><label class="toggle-switch"><input type="checkbox"
                                                name="linkedin_status"
                                                <?php echo e($business_setup->linkedin_status == '1' ? 'checked' : ''); ?>
                            ...
                            <div class="form-group"><label>Youtube</label>
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                    ...
                                    <div class="w-78"><input type="text" name="youtube_url" class="form-control"
                                            value="<?php echo e($business_setup->youtube_url); ?>" disabled></div>
                                    <div class="w-15"><label class="toggle-switch"><input type="checkbox"
                                                name="youtube_status"
                                                <?php echo e($business_setup->youtube_status == '1' ? 'checked' : ''); ?>
                            ...
                            <div class="form-group"><label>Twitter</label>
                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                    ...
                                    <div class="w-78"><input type="text" name="twitter_url" class="form-control"
                                            value="<?php echo e($business_setup->twitter_url); ?>" disabled></div>
                                    <div class="w-15"><label class="toggle-switch"><input type="checkbox"
                                                name="twitter_status"
                                                <?php echo e($business_setup->twitter_status == '1' ? 'checked' : ''); ?>
        ...
        <div class="tab-pane" id="tab-prefix">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select name="system_language" class="form-select custom-input-s" disabled>
                                    <?php $lang = $localization->system_language ?? 'bn'; ?>
                                    <option value="en" <?php echo e($lang === 'en' ? 'selected' : ''); ?>>English</option>
                                    <option value="bn" <?php echo e($lang === 'bn' ? 'selected' : ''); ?>>Bengali</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select name="timezone" class="form-select custom-input-s" disabled>
                                    <?php $tz = $localization->timezone ?? 'Asia/Dhaka'; ?>
                                    <option value="Asia/Dhaka" <?php echo e($tz === 'Asia/Dhaka' ? 'selected' : ''); ?>>(GMT+6:00) Dhaka
                                    </option>
                                    <option value="Asia/Kolkata" <?php echo e($tz === 'Asia/Kolkata' ? 'selected' : ''); ?>>(GMT+5:30)
                                        Kolkata</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select name="default_currency" class="form-select custom-input-s" disabled>
                                    <?php $dc = $localization->default_currency ?? 'BDT'; ?>
                                    <option value="BDT" <?php echo e($dc === 'BDT' ? 'selected' : ''); ?>>BDT (৳)</option>
                                    <option value="USD" <?php echo e($dc === 'USD' ? 'selected' : ''); ?>>USD ($)</option>
                                    <option value="INR" <?php echo e($dc === 'INR' ? 'selected' : ''); ?>>INR (₹)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <?php $df = $localization->date_format ?? 'd-m-Y'; ?>
                                <select name="date_format" class="form-select custom-input-s" disabled>
                                    <option value="d-m-Y" <?php echo e($df === 'd-m-Y' ? 'selected' : ''); ?>>DD-MM-YYYY (29-07-2025)
                                    </option>
                                    <option value="m/d/Y" <?php echo e($df === 'm/d/Y' ? 'selected' : ''); ?>>MM/DD/YYYY (07/29/2025)
                                    </option>
                                    <option value="Y-m-d" <?php echo e($df === 'Y-m-d' ? 'selected' : ''); ?>>YYYY-MM-DD (2025-07-29)
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <?php $tf = $localization->time_format ?? '12'; ?>
                                <select name="time_format" class="form-select custom-input-s" disabled>
                                    <option value="12" <?php echo e($tf === '12' ? 'selected' : ''); ?>>12-hour (08:30 AM)</option>
                                    <option value="24" <?php echo e($tf === '24' ? 'selected' : ''); ?>>24-hour (20:30)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="currency_decimals" class="form-control custom-input-s"
                                    value="<?php echo e($localization->currency_decimals ?? 2); ?>" min="0" max="4"
                                    readonly disabled>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Default Currency</label>
                                <?php $cdc = $currency->default_currency ?? 'BDT'; ?>
                                <select name="default_currency" class="form-select custom-input-s" disabled>
                                    <option value="BDT" <?php echo e($cdc === 'BDT' ? 'selected' : ''); ?>>BDT (৳)</option>
                                    <option value="USD" <?php echo e($cdc === 'USD' ? 'selected' : ''); ?>>USD ($)</option>
                                    <option value="INR" <?php echo e($cdc === 'INR' ? 'selected' : ''); ?>>INR (₹)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?php $fy = $currency->fiscal_year_start ?? 'July'; ?>
                                <select name="fiscal_year_start" class="form-select custom-input-s" disabled>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['January', 'April', 'July', 'October']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($m); ?>" <?php echo e($fy === $m ? 'selected' : ''); ?>>
                                            <?php echo e($m); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </select>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="usd_to_bdt_rate" class="form-control"
                                    value="<?php echo e(number_format((float) ($currency->usd_to_bdt_rate ?? 118.5), 2, '.', '')); ?>"
                                    readonly disabled>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel mt-3">
                <div class="panel-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="qbit-badge-light"><i class="bx bx-calendar"></i> Year: <?php echo e(date('Y')); ?></span>
                </div>
                <div class="panel-body">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table operational-hours-table">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $operational_hours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($hour->day); ?></td>
                                    <td>
                                        <select class="form-select" id="<?php echo e(strtolower($hour->day)); ?>"
                                            name="status_<?php echo e($hour->day); ?>" disabled>
                                            <option value="Working Day" <?php echo e($hour->status == 'Working Day' ? 'selected' : ''); ?>>
                                                Working Day</option>
                                            <option value="Holiday" <?php echo e($hour->status == 'Holiday' ? 'selected' : ''); ?>>Holiday
                                            </option>
                                        </select>
                                    </td>
                                    <td><input type="time" class="form-control" name="start_<?php echo e($hour->day); ?>"
                                            value="<?php echo e($hour->start_time); ?>" disabled></td>
                                    <td><input type="time" class="form-control" name="end_<?php echo e($hour->day); ?>"
                                            value="<?php echo e($hour->end_time); ?>" disabled></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </table>
                    </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="panel setting-card-1">
                                ...
                                <div class="panel-body text-center"><img alt="Main logo"
                                        src="<?php echo e(asset('storage/' . $business_setup->logo)); ?>" class="my-3"><label
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="panel setting-card-1">
                                ...
                                <div class="panel-body text-center"><img alt="Alt logo"
                                        src="<?php echo e(asset('storage/' . $business_setup->alt_logo)); ?>" class="my-3"><label
                                        class="setting-button-1 w-100"><i class="bx bx-cloud-upload"></i> Choose
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="panel setting-card-1">
                                ...
                                <div class="panel-body text-center"><img alt="Favicon"
                                        src="<?php echo e(asset('storage/' . $business_setup->favicon)); ?>" class="my-3"><label
                                        class="setting-button-1 w-100"><i class="bx bx-cloud-upload"></i> Choose
                            ...
                            <div class="panel setting-card-1">
                                ...
                                <div class="panel-body text-center">
                                    <img alt="Login Background" style="max-height: 120px; object-fit: cover;"
                                        src="<?php echo e($business_setup->login_background ? asset('storage/' . $business_setup->login_background) : asset('frontend/assets/images/page-bg.jpg')); ?>" class="my-3 img-fluid rounded">
                            ...
                            <div class="panel setting-card-1">
                                ...
                                <div class="panel-body text-center">
                                    <img alt="Login Image" style="max-height: 120px; object-fit: cover;"
                                        src="<?php echo e($business_setup->login_image ? asset('storage/' . $business_setup->login_image) : 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400&h=300&fit=crop'); ?>" class="my-3 img-fluid rounded">
                                    <label class="setting-button-1 w-100"><i class="bx bx-cloud-upload"></i> Choose file
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="login_title" class="form-control"
                                    value="<?php echo e($business_setup->login_title ?? ''); ?>"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="login_tagline" class="form-control"
                                    value="<?php echo e($business_setup->login_tagline ?? ''); ?>"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="login_subtitle" class="form-control"
                                    value="<?php echo e($business_setup->login_subtitle ?? ''); ?>"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="login_copyright" class="form-control"
                                    value="<?php echo e($business_setup->login_copyright ?? ''); ?>"
                    ...
                    <div class="row g-3">
                        <div class="col-lg-4">
                            <div class="form-group"><label>Auto Backup Frequency</label><select class="form-select"
                                    ...
                                    <option <?php echo e($business_setup->auto_backup_frequency == 'Daily' ? 'selected' : ''); ?>>Daily
                                    </option>
                                    <option <?php echo e($business_setup->auto_backup_frequency == 'Weekly' ? 'selected' : ''); ?>>
                                        Weekly</option>
                                </select></div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group"><label>Backup Time</label><input type="time" name="backup_time"
                                    class="form-control" value="<?php echo e($business_setup->backup_time); ?>" disabled></div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group"><label>Backup Retention (days)</label><input type="number"
                                    name="backup_retention" class="form-control"
                                    value="<?php echo e($business_setup->backup_retention); ?>" disabled></div>
                        </div>
                    </div>
                </div>
                <div class="panel-footer text-end d-none"><button type="button"
            ...
            <div class="panel mt-3">
                ...
                <div class="panel-body">
                    <div class="page-inner">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $prefixes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prefix): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-round">
                                        <div class="card-body">
                                            <form class="prefix-update-form"
                                                action="<?php echo e(route('admin.users.business-setup.prefix-update', $prefix->id)); ?>"
                                                method="POST">
                                                <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="card-body p-2">
                                                                <a class="align-items-center" data-bs-toggle="collapse"
                                                                    ...
                                                                    <h5
                                                                        ...
                                                                        <?php echo e(Str::title(str_replace('_', ' ', $prefix->prefix_name))); ?>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            <div
                                                                                ...
                                                                                <label><?php echo e(Str::title(str_replace('_', ' ', $prefix->prefix_name))); ?>
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                id="prefix_style_<?php echo e($prefix->id); ?>"
                                                                                placeholder="<?php echo e(Str::title(str_replace('_', ' ', $prefix->prefix_name))); ?> Prefix"
                                                                                name="prefix_style"
                                                                                value="<?php echo e($prefix->prefix_style); ?>"
                                                                                readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="custom-border-success-1 pb-3 rounded">
                                                            ...
                                                            <div class="pt-2 pb-2 card-body client-details-inner">
                                                                <div class="row prefix-format-group"
                                                                    data-prefix-id="<?php echo e($prefix->id); ?>">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            ?>
                                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $formats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $format): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <div class="form-check me-3">
                                                                                    <input
                                                                                        ...
                                                                                        id="format_<?php echo e($prefix->id); ?>_<?php echo e($i); ?>"
                                                                                        <?php echo e($prefix->prefix_format == $format ? 'checked' : ''); ?>>
                                                                                    <label
                                                                                        class="form-check-label fs-12 fw-300 text-black-1"
                                                                                        for="format_<?php echo e($prefix->id); ?>_<?php echo e($i); ?>">
                                                                                        <?php echo e($format); ?>
                                                                    ...
                                                                    <div class="col-sm-2 pe-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="prefix_code_<?php echo e($prefix->id); ?>">Prefix
                                                                                Code</label>
                                                                            <input type="text"
                                                                                class="form-control custom-input"
                                                                                id="prefix_code_<?php echo e($prefix->id); ?>"
                                                                                name="prefix_code"
                                                                                value="<?php echo e($prefix->prefix_code); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-2 px-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="separators_<?php echo e($prefix->id); ?>">Separators</label>
                                                                            <input type="text"
                                                                                class="form-control custom-input"
                                                                                id="separators_<?php echo e($prefix->id); ?>"
                                                                                name="separators"
                                                                                value="<?php echo e($prefix->separators); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-2 ps-2">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="digit_limit_<?php echo e($prefix->id); ?>">Digit
                                                                                Limit</label>
                                                                            <input type="number" min="1"
                                                                                class="form-control custom-input"
                                                                                id="digit_limit_<?php echo e($prefix->id); ?>"
                                                                                name="digit_limit"
                                                                                value="<?php echo e($prefix->digit_limit); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            $(function() {
                 ...
                 * Constants
                 * =========================== */
                const BUSINESS_ID = "<?php echo e($business_setup->id); ?>";
                const ROUTES = {
                    update: "<?php echo e(route('admin.users.business-setup.update', ':id')); ?>".replace(':id', BUSINESS_ID),
                    holidaysIndex: "<?php echo e(route('admin.users.business-setup.public-holidays')); ?>",
                    holidaysStore: "<?php echo e(route('admin.users.business-setup.public-holidays.store')); ?>",
                    holidaysDelete: "/admin/business-setup/public-holiday/destroy/", // + id
                    docsIndex: "<?php echo e(route('admin.users.business-setup.documents')); ?>",
                    docsStore: "<?php echo e(route('admin.users.business-setup.documents.store')); ?>",
                    docsDeleteBase: "<?php echo e(url('admin/business-setup/documents')); ?>", // + /:id
                };
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\QBit Dev-2\Downloads\projects\e-commerce-laravel\resources\views/admin/business_settings/business_setup.blade.php ENDPATH**/ ?>