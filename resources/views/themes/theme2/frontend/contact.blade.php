                ...
                <div class="contact-info" data-aos="fade-up">
                    ...
                    <div class="contact-cards">
                        <div class="contact-card d-flex align-items-start mb-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="icon-box me-4" style="width: 60px; height: 60px; background: var(--light-cream); border: 1px solid var(--gold-brown); border-radius: 15px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                <i class="fa-solid fa-phone fa-lg" style="color: var(--primary-red);"></i>
                            </div>
                            <div>
                        ...
                        <div class="contact-card d-flex align-items-start mb-4" data-aos="fade-up" data-aos-delay="200">
                            <div class="icon-box me-4" style="width: 60px; height: 60px; background: var(--light-cream); border: 1px solid var(--gold-brown); border-radius: 15px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                <i class="fa-solid fa-envelope fa-lg" style="color: var(--primary-red);"></i>
                            </div>
                            <div>
                        ...
                        <div class="contact-card d-flex align-items-start mb-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="icon-box me-4" style="width: 60px; height: 60px; background: var(--light-cream); border: 1px solid var(--gold-brown); border-radius: 15px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                <i class="fa-solid fa-location-dot fa-lg" style="color: var(--primary-red);"></i>
                            </div>
                            <div>
                        ...
                        <div class="contact-card d-flex align-items-start" data-aos="fade-up" data-aos-delay="400">
                            <div class="icon-box me-4" style="width: 60px; height: 60px; background: var(--light-cream); border: 1px solid var(--gold-brown); border-radius: 15px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                <i class="fa-solid fa-clock fa-lg" style="color: var(--primary-red);"></i>
                            </div>
                            <div>
