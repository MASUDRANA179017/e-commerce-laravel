                                ...
                                <ul>
                                    ...
                                    @foreach($categories as $category)
                                        <li class="{{ request('category') == $category->slug ? 'active' : '' }}">
                                            <a
                                                href="{{ route('shop.index', array_merge(request()->except('category', 'page'), ['category' => $category->slug])) }}">
                                                <i class="fa-solid fa-angle-right"></i>{{ $category->name }}
                                                <span
                                                    class="badge bg-light text-dark float-end">{{ $category->products_count }}</span>
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="shop-sidebar-widget" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                            ...
                            <div class="filter-wrapper">
                                <form action="{{ route('shop.index') }}" method="get">
                                    ...
                                    <button type="submit" class="btn--primary w-100" aria-label="filter"
