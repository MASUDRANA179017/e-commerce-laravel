...
<div class="row">
    ...
    <div class="col-xl-3 col-sm-6 mb-4">
        <div class="stat-card-modern">
            ...
            <div class="mt-2">
                <small class="text-muted">Today: <span class="fw-bold text-dark">৳{{ number_format($todayStats['revenue'], 0) }}</span></small>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-sm-6 mb-4">
        <div class="stat-card-modern">
            ...
            <div class="mt-2">
                <small class="text-muted">This month: <span class="fw-bold text-dark">{{ $monthStats['orders'] }}</span></small>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-sm-6 mb-4">
        <div class="stat-card-modern">
            ...
            <div class="mt-2">
                <small class="text-muted">Categories: <span class="fw-bold text-dark">{{ $stats['total_categories'] }}</span></small>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-sm-6 mb-4">
        <div class="stat-card-modern">
            ...
            <div class="mt-2">
                <small class="text-muted">Brands: <span class="fw-bold text-dark">{{ $stats['total_brands'] }}</span></small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xxl-6 mb-4">
        <div class="card border-0 h-100">
            <div class="card-header bg-white d-flex align-items-center justify-content-between">
                <h5 class="mb-0 fw-bold qb-card-header-title-14-600"><i class="bx bx-trending-up me-2"></i>Top Products</h5>
                <a href="{{ route('admin.product.all') }}" class="qbit-badge-purple">View All</a>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
