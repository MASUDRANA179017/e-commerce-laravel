...
@php
    ...
    $recentOrderActivities = Order::latest()->limit(5)->get()->toBase()->map(function ($order) {
        return [
            'type' => 'order',
            'icon' => 'bx-cart',
            'color' => 'primary',
    ...
    $recentUserActivities = User::latest()->limit(3)->get()->toBase()->map(function ($user) {
        return [
            'type' => 'user',
            'icon' => 'bx-user-plus',
            'color' => 'success',
...
@push('styles')
    <style>
        ...
        .trend-up {
            background: rgba(140, 192, 82, 0.15);
            color: #8CC052;
        }

        .trend-down {
            background: rgba(235, 84, 99, 0.15);
            color: #EB5463;
        }
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="mt-2">
                    <small class="text-muted">Today: <span
                            class="fw-bold text-dark">৳{{ number_format($todayStats['revenue'], 0) }}</span></small>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="stat-card-modern">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <span class="qbit-badge-success">{{ $todayStats['orders'] }} today</span>
                </div>
                <h3 class="fw-bold mb-1">{{ number_format($stats['total_orders']) }}</h3>
                <p class="text-muted mb-0 fs-13">Total Orders</p>
                <div class="mt-2">
                    <small class="text-muted">This month: <span
                            class="fw-bold text-dark">{{ $monthStats['orders'] }}</span></small>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="mt-2">
                    <small class="text-muted">Categories: <span
                            class="fw-bold text-dark">{{ $stats['total_categories'] }}</span></small>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="stat-card-modern">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <span class="qbit-badge-orange">+{{ $todayStats['new_customers'] }} new</span>
                </div>
                <h3 class="fw-bold mb-1">{{ number_format($stats['total_users']) }}</h3>
                <p class="text-muted mb-0 fs-13">Total Customers</p>
                <div class="mt-2">
                    <small class="text-muted">Brands: <span
                            class="fw-bold text-dark">{{ $stats['total_brands'] }}</span></small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="custom-counter-inner counter-bg-1">
                <svg class="bottom-svg" viewBox="0 0 80 60" fill="none">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-700 fs-24 mb-0">{{ $stats['pending_orders'] }}</h3>
        ...
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="custom-counter-inner counter-bg-2">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-700 fs-24 mb-0">{{ $stats['processing_orders'] }}</h3>
        ...
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="custom-counter-inner counter-bg-3">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-700 fs-24 mb-0">{{ $stats['completed_orders'] }}</h3>
        ...
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="custom-counter-inner"
                style="background: linear-gradient(135deg, #fff5f5 0%, #ffe5e5 100%); border: 1px solid rgba(235, 84, 99, 0.2);">
                <svg class="bottom-svg" viewBox="0 0 80 60" fill="none">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-700 fs-24 mb-0">{{ $stats['cancelled_orders'] }}</h3>
        ...
        <div class="col-xxl-8 mb-4">
            <div class="card border-0 h-100">
                <div class="card-header bg-white d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 fw-bold qb-card-header-title-14-600"><i class="bx bx-receipt me-2"></i>Recent Orders
                    </h5>
                    <a href="{{ route('admin.orders.index') }}" class="qbit-badge-primary">View All <i
                            ...
                            <tbody>
                                @forelse($recentOrders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="customer-avatar"
                                                    style="background: linear-gradient(135deg, var(--qbit-primary) 0%, var(--qbit-purple) 100%);">
                                        ...
                                        <td><span class="qbit-badge-info"><i class="bx bx-package"></i>
                                                {{ $order->items->count() }}</span></td>
                                        ...
                                        <td class="text-end pe-3">
                                            <a href="{{ route('admin.orders.show', $order->id) }}" class="action-btn-info"
        ...
        <div class="col-xxl-4 mb-4">
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <div class="card border-0">
                        <div class="card-header bg-white">
                            <h5 class="mb-0 fw-bold qb-card-header-title-14-600"><i class="bx bx-time me-2"></i>Recent
                                Activity</h5>
                        </div>
                            ...
                            @forelse($recentActivities as $activity)
                                <div class="activity-item">
                                    <div class="activity-icon"
                                        style="background: rgba(var(--qbit-{{ $activity['color'] }}-rgb), 0.15);">
                                        <i class="bx {{ $activity['icon'] }}"
                                            style="color: var(--qbit-{{ $activity['color'] }});"></i>
                                    </div>
                ...
                <div class="col-12">
                    <div class="card border-0">
                        <div class="card-header bg-white d-flex align-items-center justify-content-between">
                            <h5 class="mb-0 fw-bold qb-card-header-title-14-600"><i
                                    class="bx bx-error me-2 text-danger"></i>Low Stock</h5>
                            <span class="qbit-badge-danger"><i class="bx bx-error"></i>
                                {{ count($lowStockProducts) }}</span>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                        ...
                                        @forelse($lowStockProducts as $product)
                                            <tr>
                                                <td class="py-3 ps-3">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div
                                                            class="wh-40 rounded bg-light d-flex align-items-center justify-content-center">
                                                            <i class="bx bx-package text-muted"></i>
                                                        </div>
                                                        <div>
                                                            <span
                                                                class="fw-medium fs-13 d-block">{{ Str::limit($product->title ?? $product->name, 20) }}</span>
                                                            <small class="text-danger"><i class="bx bx-error-circle"></i>
                                                                {{ $product->stock_quantity ?? 0 }} left</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-3 pe-3 text-end">
                                                    <a href="{{ route('admin.inventory.stock') }}" class="action-btn-orange"
                                                        title="Restock"><i class="bx bx-plus"></i></a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
        ...
        <!-- Top Products & Weekly Sales Chart -->
        <div class="col-xxl-6 mb-4">
            <div class="card border-0 h-100">
                <div class="card-header bg-white d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 fw-bold qb-card-header-title-14-600"><i class="bx bx-trending-up me-2"></i>Top Products
                    </h5>
                    <a href="{{ route('admin.product.all') }}" class="qbit-badge-purple">View All</a>
                </div>
                <div class="card-body p-0">
                                ...
                                @forelse($topProducts as $index => $product)
                                    <tr>
                                        <td class="py-3 ps-3" style="width: 40px;">
                                            <span
                                                class="qbit-badge-{{ $index == 0 ? 'success' : ($index == 1 ? 'primary' : ($index == 2 ? 'info' : 'gray')) }}">
                                                #{{ $index + 1 }}
                                            </span>
                                        </td>
                                        <td class="py-3">
                                            <div class="d-flex align-items-center gap-3">
                                                <div
                                                    class="wh-45 rounded bg-light d-flex align-items-center justify-content-center overflow-hidden">
                                                    @php
                                                        $coverImg = DB::table('product_images')->where('product_id', $product->id)->where('is_cover', true)->first();
                                                    @endphp
                                                    @if($coverImg)
                                                        <img src="{{ asset('storage/' . $coverImg->path) }}"
                                                ...
                                                <div>
                                                    <span
                                                        class="fw-medium d-block">{{ Str::limit($product->title ?? $product->name, 25) }}</span>
                                                    <small
                                                        class="text-muted">৳{{ number_format($product->price ?? 0, 2) }}</small>
                                                </div>
                                            </div>
                                        </td>
        ...
        <div class="col-xxl-6 mb-4">
            <div class="chart-card h-100">
                <div class="card-header bg-white p-3">
                    <h5 class="mb-1 fw-bold qb-card-header-title-14-600"><i class="bx bx-line-chart me-2"></i>Weekly Sales
                    </h5>
