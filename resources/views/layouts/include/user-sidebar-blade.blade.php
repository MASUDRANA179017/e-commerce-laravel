<div class="sidebar-area" id="sidebar-area">
    <div class="logo position-relative">
        <a href="{{ route('user.dashboard') }}" class="d-flex align-items-center text-decoration-none position-relative">
            <img src="{{ (isset($business_setup) && $business_setup?->logo) ? asset('storage/' . $business_setup->logo) : asset('assets/images/landing/logo.svg') }}" class="h-37px" alt="{{ isset($business_setup) ? ($business_setup->company_name ?? 'Logo') : 'Logo' }}">
