...
<html lang="zxx">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/qbit-bms-style.css">
		
		<!-- Favicon -->
		<link rel="icon" type="image/png" href="assets/images/QBit-Tech_Fevicon.png">
		<!-- Title -->
		<title>QBit BMS - Echosystem</title>
                                ...
                                <ul class="d-flex align-items-center justify-content-center justify-content-sm-end ps-0 mb-0 list-unstyled">
                                    ...
                                    <li class="header-right-item">
                                        <div class="dropdown admin-profile">
                                            <div class="d-xxl-flex align-items-center cursor dropdown-toggle" data-bs-toggle="dropdown">
                                                <div class="flex-shrink-0">
                                                    <img class=" administrator" src="assets/images/user-161.png" alt="admin">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <i class="material-symbols-outlined me-2" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Click On Theme Settings">settings_account_box</i>
                                                    </div>
                                                </div>
                                            </div>
