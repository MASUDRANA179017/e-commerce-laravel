...
<head>
    ...
    <style>
        :root {
            --primary-color: {{ $business_setup->theme_color_primary ?? '#0496ff' }};
            --secondary-color: {{ $business_setup->theme_color_secondary ?? '#1a1a2e' }};
            --accent-color: {{ $business_setup->theme_color_accent ?? '#f9c123' }};
            --success-color: #0ab969;
            --danger-color: #dc3545;
            --light-bg: #f8f9fa;
            --dark-bg: #1a1a2e;
            --font-primary: '{{ $business_setup->theme_font_primary ?? 'Outfit' }}', sans-serif;
            --font-base-size: {{ $business_setup->theme_font_base_size ?? '16px' }};
        }
