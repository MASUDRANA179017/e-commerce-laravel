...
<head>
    ...
    <style>
        ...
        .add-to-wishlist.text-danger { color: #dc3545 !important; }
        .add-to-wishlist.active i,
        .add-to-wishlist.text-danger i { color: #dc3545 !important; }
...
<body>
    <div class="page-wrapper">
                        ...
                        <div class="topbar-six__wrapper d-flex justify-content-between align-items-center">
                            ...
                            <div class="topbar__list-wrapper">
                                <ul class="topbar__list topbar-six-list">
                                    <li>
                                        <a class="fw-normal" href="mailto:{{ config('mail.from.address', 'info@shop.com') }}">
                                            <i class="fa-regular fa-envelope"></i> {{ config('mail.from.address', 'info@shop.com') }}
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="topbar-six-right">
                                <ul class="d-flex footer__bottom-list gap-4 justify-content-center justify-content-lg-end">
                                    @guest
                                        <li><a class="fw-normal" href="{{ route('login') }}"><i class='bx bx-user'></i> Login</a></li>
                                        <li><a class="fw-normal" href="{{ route('register') }}"><i class='bx bx-user-plus'></i> Register</a></li>
                                    @else
                                        <li><a class="fw-normal" href="{{ route('dashboard') }}"><i class='bx bx-user'></i> My Account</a></li>
                                    @endguest
                                </ul>
                            </div>
                        </div>
                            ...
                            <nav class="navbar p-0">
                                ...
                                <div class="navbar-logo">
                                    <a href="{{ route('home') }}" aria-label="Home">
                                        <img src="{{ asset('frontend/assets/images/logo.png') }}" alt="{{ config('app.name') }}" height="50">
                                    </a>
                                </div>
                                <!-- Nav -->
        ...
        <div class="mobile-menu d-block d-xxl-none">
            <nav class="mobile-menu__wrapper" aria-label="Mobile">
                ...
                <div class="mobile-menu__cta nav-fade d-block d-md-none">
                    <a href="{{ route('shop.index') }}" class="btn--primary">Shop Now <i class="fa-solid fa-shopping-bag ms-1"></i></a>
                </div>
        ...
        <!-- ========== FOOTER ========== -->
        <footer class="footer-two footer-six-area footer-eight-area" data-background="{{ asset('frontend/assets/images/footer-eight-bg.jpg') }}">
            <div class="container">
                            ...
                            <div class="footer-eight-top-wrap">
                                <div class="subscribe-six-input">
                                    ...
                                    <div class="subscribe-six-button subscribe-eight-button">
                                        <button class="btn--primary btn-six-primary d-none d-md-flex text-white fw-medium rounded-5">Subscribe</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-3">
                        <div class="footer-two__widget">
                            ...
                            <div class="footer-two__widget-content">
                                <p class="sub-itle-lg">
                                    Your one-stop destination for quality products at affordable prices. Shop with confidence and enjoy fast delivery.
                                </p>
                                <div class="social">
                    ...
                    <div class="col-12 col-md-6 col-xl-2 offset-xl-1">
                        <div class="footer-two__widget">
                            ...
                            <div class="footer-two__widget-content">
                                <ul>
                                    <li><a class="text-white sub-title-lg" href="{{ route('home') }}"><span><i class="fa-solid fa-angle-right me-2"></i></span> Home</a></li>
                                    <li><a class="text-white sub-title-lg" href="{{ route('shop.index') }}"><span><i class="fa-solid fa-angle-right me-2"></i></span> Shop</a></li>
                                    <li><a class="text-white sub-title-lg" href="{{ route('frontend.about') }}"><span><i class="fa-solid fa-angle-right me-2"></i></span> About Us</a></li>
                                    <li><a class="text-white sub-title-lg" href="{{ route('frontend.contact') }}"><span><i class="fa-solid fa-angle-right me-2"></i></span> Contact Us</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-xl-3">
                        <div class="footer-two__widget footer-two__widget--alternate">
                            ...
                            <div class="footer-two__widget-content">
                                <ul>
                                    <li><a class="text-white sub-title-lg" href="{{ route('cart.index') }}"><span><i class="fa-solid fa-angle-right me-2"></i></span> My Cart</a></li>
                                    <li><a class="text-white sub-title-lg" href="{{ route('wishlist.index') }}"><span><i class="fa-solid fa-angle-right me-2"></i></span> Wishlist</a></li>
                                    <li><a class="text-white sub-title-lg" href="#"><span><i class="fa-solid fa-angle-right me-2"></i></span> Track Order</a></li>
                                    <li><a class="text-white sub-title-lg" href="#"><span><i class="fa-solid fa-angle-right me-2"></i></span> Returns & Refunds</a></li>
                                    <li><a class="text-white sub-title-lg" href="#"><span><i class="fa-solid fa-angle-right me-2"></i></span> FAQs</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer-two__widget footer-two__widget--alternate">
                            ...
                            <div class="footer-two__widget-content footer-two__widget-content--contact">
                                <ul>
                                    ...
                                    <li><a class="text-white sub-title-lg" href="tel:+8801700000000"><i class="fa-solid fa-phone"></i> +880 1700-000000</a></li>
                                    <li><a class="text-white sub-title-lg" href="mailto:info@shop.com"><i class="fa-solid fa-envelope"></i> info@shop.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center gutter-12 footer-six-copyright-border position-relative">
                        <div class="col-12 col-lg-6">
                            <div class="footer-two__copyright-inner text-center text-lg-start">
                                <p>Copyright &copy; <span id="copyrightYear">{{ date('Y') }}</span> <a href="{{ route('home') }}">{{ config('app.name') }}</a>. All rights reserved.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
